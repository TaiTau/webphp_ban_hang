...
class order
{
    ...
    public function show_chitiet_order($id)
    {
        $squery = "SELECT * FROM tbl_chitietdonhang WHERE donhang_id = '$id'" ;
        $result = $this ->db->select($squery);
        return $result;
    }
    public function get_amount($cus_id){
        $query = "SELECT tongtien FROM tbl_donhang WHERE kh_id = '$cus_id'";
        $get_price = $this->db->select($query);
        return $get_price;
    }
    public function get_hd($hdid){
        $query = "SELECT * FROM tbl_chitietdonhang WHERE donhang_id = '$hdid'";
        $get_price = $this->db->select($query);
        return $get_price;
    }
