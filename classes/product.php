...
class productadd
{
    ...
    public function update_pro($data,$files,$id)
    {
        ...
        $product_hot = mysqli_real_escape_string($this->db->link,$data['sanpham_hot']);
        $product_sl = mysqli_real_escape_string($this->db->link,$data['sanpham_soluong']);
        ...
        if($productName=="" || $sanphamgia=="" || $sanpham_soluong=="" || $sanpham_giakm==""){
            ...
            if(!empty($file_name)){
                ...
                if ($file_size > 204800) {
                 ...
                 $alert = "<span class='success'>Dung lượng ảnh phải bé hơn 2MB!</span>";
                return $alert;
                } 
                ...
                sanpham_soluong= '$product_sl',
                sanpham_hot  ='$product_hot',
    ...
    public function insert_product($data,$files){
        ...
        $product_mota2 = mysqli_real_escape_string($this->db->link,$data['sanpham_mota2']);
        $product_hot = mysqli_real_escape_string($this->db->link,$data['sanpham_hot']);
        $product_sl = mysqli_real_escape_string($this->db->link,$data['sanpham_soluong']);
        ...
        if($product_name == "" || $product_price == "" || $product_soluong == "" || $product_pricekm == "" ||  $file_name == "" || $product_mota == ""){
            ...
            move_uploaded_file($file_temp,$uploaded_image);
            $query = "INSERT INTO tbl_sanpham(sanpham_name,sanpham_gia,category_id,sanpham_image,sanpham_giakhuyenmai,sanpham_mota,sanpham_mota2,sanpham_hot,sanpham_soluong) VALUES('$product_name','$product_price','$product_soluong','$unique_image','$product_pricekm','$product_mota','$product_mota2','$product_hot','$product_sl') LIMIT 1";
