...
<div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      <div class="logo"><a href="../admin/index.php" class="simple-text logo-normal">
          admin
        </a></div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
          <a class="nav-link" href="../admin/QLBL.php">
              <i class="material-icons">library_books</i>
              <p>Quản lý bình luận</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="javascript: toggleChildren('cat4');">
            <i class="far fa-newspaper"></i>
              <p>Quản lý tin tức</p>
            </a>
            <div class="sub_cat_box"  id="cat4">
            <ul class ="ulcon">
            <li class="nav-item ">
            <a class="nav-link" href="../admin/QLTT.php">
            <i class="far fa-newspaper"></i>
              <p>Danh sách tin tức</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="../admin/themtt.php">
            <i class="far fa-newspaper"></i>
              <p>Thêm tin tức</p>
            </a>
          </li>
          ...
          <li class="nav-item ">
          <a class="nav-link" href="../admin/tkbc.php">
          <i class="fas fa-shopping-bag"></i>
